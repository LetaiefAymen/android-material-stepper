 ...
 */
public abstract class AbstractStateFragmentStepAdapter
    ...
    public AbstractStateFragmentStepAdapter(@NonNull FragmentManager fm, @NonNull Context context) {
        super(fm);
